...
## Live enhancement and HDR

Choose DLSS 100%, 75% or 50%, Off, or RTX VSR. Off and VSR bypass DLSS; HDR remains independent. VSR scales decoded frames toward the selected output bounds (up to 4×). Buffered playback has been removed.
