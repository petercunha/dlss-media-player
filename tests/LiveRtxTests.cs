...
class LiveRtxTests{
 ...
 static async Task Test(string[] a){
  var e=new Engine(a[0]);e.LiveRtxMode=a.Length>5?int.Parse(a[5]):3;e.LiveTarget=int.Parse(a[2]);e.Log=Console.WriteLine;e.LiveSourceResolution=a.Length>3&&a[3]=="source";e.SetWorkResolution(e.LiveSourceResolution?100:50);
