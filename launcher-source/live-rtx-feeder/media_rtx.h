...
static State s,pre;
static ComPtr<ID3D11Texture2D> preCrop,preOutput;
static ComPtr<ID3D11RenderTargetView> preRtv;
static ComPtr<ID3D11ShaderResourceView> preSrv;
...
static void Destroy(reshade::api::effect_runtime* runtime){if(runtime->get_device()->get_api()==reshade::api::device_api::d3d11){s=State{};pre=State{};preCrop.Reset();preOutput.Reset();preRtv.Reset();preSrv.Reset();}}
