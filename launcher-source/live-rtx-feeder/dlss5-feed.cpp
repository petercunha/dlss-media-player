...
{
    // MPV renders SDR into an RGB10 carrier; HDR is introduced only after DLSS.
    if(MediaRtx::Mode()&&MediaRtx::s.swap)MediaRtx::s.swap->SetColorSpace1(DXGI_COLOR_SPACE_RGB_FULL_G22_NONE_P709);
    LARGE_INTEGER t0, t1;
    QueryPerformanceCounter(&t0);
