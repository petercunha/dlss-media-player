...
sealed partial class Engine {
    ...
    public IEnumerable<string> LiveArguments(){
        ...
        if(LiveSourceResolution && (LiveRtxMode&1)!=0){
            ...
            Log("Live work size: source resolution. MPV does not enlarge the video; DLSS enhances it before VSR scales to the display. Small windows may downscale to fit.");
        }
